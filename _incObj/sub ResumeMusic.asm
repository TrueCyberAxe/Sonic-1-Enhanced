...
ResumeMusic:
		...
		bhi.s	.over12		    ; if yes, branch            move.w #bgm_LZ,d0
		queue_music	#bgm_LZ	    ; load LZ music
		cmpi.w	#id_LZ_act4,(v_zone).w ; check if level is SBZ3 (LZ4)
		bne.s	.notsbz
		queue_music	#bgm_SBZ	; load SBZ music        	move.w #bgm_SBZ,d0
...
.notinvinc:
		...
		queue_music	#bgm_Boss	; load Boss music
.playselected:
	endif
