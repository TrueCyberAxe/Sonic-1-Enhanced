...
Gra_Title:			incbin	"artkos\8x8 - GHZ1.kosp"	; GHZ primary patterns
		endc
		even
...
Gra_Title:		incbin	"artnem\8x8 - GHZ1.nem"	; GHZ primary patterns
		even
Gra_GHZ:			incbin	"artkos\8x8 - GHZ2.kosp"	; GHZ secondary patterns
	else
Gra_GHZ:	  	incbin	"artkos\8x8 - GHZ.kosp"	; GHZ combined patterns
	endc ; if TweakMergedArt=0
		even
	if TweakMergedArt=0
Blk256_TITLE:
...
Blk16_LZ:			incbin	"map16\LZ.eni"
		even
Gra_LZ:				incbin	"artkos\8x8 - LZ.kosp"	; LZ primary patterns
		even
	if TweakUncompressedChunkMapping=0
...
Blk16_MZ:			incbin	"map16\MZ.eni"
		even
Gra_MZ:				incbin	"artkos\8x8 - MZ.kosp"	; MZ primary patterns
		even
Blk256_MZ:
	if Revision=0
		if TweakUncompressedChunkMapping=0
...
Blk16_SLZ:		incbin	"map16\SLZ.eni"
		even
Gra_SLZ:			incbin	"artkos\8x8 - SLZ.kosp"	; SLZ primary patterns
		even
	if TweakUncompressedChunkMapping=0
...
Blk16_SYZ:		incbin	"map16\SYZ.eni"
		even
Gra_SYZ:			incbin	"artkos\8x8 - SYZ.kosp"	; SYZ primary patterns
		even
	if TweakUncompressedChunkMapping=0
...
Blk16_SBZ:		incbin	"map16\SBZ.eni"
		even
Gra_SBZ:			incbin	"artkos\8x8 - SBZ.kosp"	; SBZ primary patterns
		even
Blk256_SBZ:
	if Revision=0
		if TweakUncompressedChunkMapping=0
