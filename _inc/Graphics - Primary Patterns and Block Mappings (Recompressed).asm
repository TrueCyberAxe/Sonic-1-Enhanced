...
Gra_Title:		incbin	"artnem\8x8 - GHZ1.nem"	; GHZ primary patterns
		even
Gra_GHZ:			incbin	"artnem\8x8 - GHZ2.nem"	; GHZ secondary patterns
	else
...
Blk16_LZ:			incbin	"map16\LZ.eni"
		even
Gra_LZ:				incbin	"artnem\8x8 - LZ.nem"	; LZ primary patterns
		even
	if TweakUncompressedChunkMapping=0
...
Blk16_MZ:			incbin	"map16\MZ.eni"
		even
Gra_MZ:				incbin	"artnem\8x8 - MZ.nem"	; MZ primary patterns
		even
Blk256_MZ:
	if Revision=0
		if TweakUncompressedChunkMapping=0
...
Blk16_SLZ:		incbin	"map16\SLZ.eni"
		even
Gra_SLZ:			incbin	"artnem\8x8 - SLZ.nem"	; SLZ primary patterns
		even
	if TweakUncompressedChunkMapping=0
...
Blk16_SYZ:		incbin	"map16\SYZ.eni"
		even
Gra_SYZ:			incbin	"artnem\8x8 - SYZ.nem"	; SYZ primary patterns
		even
	if TweakUncompressedChunkMapping=0
...
Blk16_SBZ:		incbin	"map16\SBZ.eni"
		even
Gra_SBZ:			incbin	"artnem\8x8 - SBZ.nem"	; SBZ primary patterns
		even
Blk256_SBZ:
	if Revision=0
		if TweakUncompressedChunkMapping=0
