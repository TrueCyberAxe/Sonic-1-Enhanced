...
;				level gfx*			16x16 data			music*
	...
	lhead	plcid_GHZ,	Gra_GHZ,			plcid_GHZ2,	Blk16_GHZ,	Blk256_GHZ,	bgm_GHZ,	palid_GHZ		; Green Hill
	lhead	plcid_LZ,		Gra_LZ,				plcid_LZ2,	Blk16_LZ,		Blk256_LZ,	bgm_LZ,		palid_LZ		; Labyrinth
	lhead	plcid_MZ,		Gra_MZ,				plcid_MZ2,	Blk16_MZ,		Blk256_MZ,	bgm_MZ,		palid_MZ		; Marble
	lhead	plcid_SLZ,	Gra_SLZ,			plcid_SLZ2,	Blk16_SLZ,	Blk256_SLZ,	bgm_SLZ,	palid_SLZ		; Star Light
	lhead	plcid_SYZ,	Gra_SYZ,			plcid_SYZ2,	Blk16_SYZ,	Blk256_SYZ,	bgm_SYZ,	palid_SYZ		; Spring Yard
