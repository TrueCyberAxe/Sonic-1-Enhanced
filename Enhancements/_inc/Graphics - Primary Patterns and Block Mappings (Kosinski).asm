...
Blk16_TITLE:		incbin	"Enhancements/map16/GHZ.eni"
		even
		if TweakTitleCompress
Gra_Title:			incbin	"Enhancements/artkos/8x8 - GHZ1.kosp"	; GHZ primary patterns
		else
...
Blk16_GHZ:		incbin	"Enhancements/map16/GHZ.eni"
		even
	if TweakMergedArt
Gra_GHZ:	  	incbin	"Enhancements/artkos/8x8 - GHZ.kosp"	; GHZ combined patterns
	else
Gra_Title:		incbin	"Enhancements/artnem/8x8 - GHZ1.nem"	; GHZ primary patterns
		even
Gra_GHZ:			incbin	"Enhancements/artkos/8x8 - GHZ2.kosp"	; GHZ secondary patterns
	endif ; if TweakMergedArt
		even
	if TweakMergedArt=0
Blk256_TITLE:
...
Blk16_LZ:			incbin	"Enhancements/map16/LZ.eni"
		even
Gra_LZ:				incbin	"Enhancements/artkos/8x8 - LZ.kosp"	; LZ primary patterns
		even
	if TweakUncompressedChunkMapping
...
Blk16_MZ:			incbin	"Enhancements/map16/MZ.eni"
		even
Gra_MZ:				incbin	"Enhancements/artkos/8x8 - MZ.kosp"	; MZ primary patterns
		even
Blk256_MZ:
	if Revision=0
		if TweakUncompressedChunkMapping
...
Blk16_SLZ:		incbin	"Enhancements/map16/SLZ.eni"
		even
Gra_SLZ:			incbin	"Enhancements/artkos/8x8 - SLZ.kosp"	; SLZ primary patterns
		even
	if TweakUncompressedChunkMapping
...
Blk16_SYZ:		incbin	"Enhancements/map16/SYZ.eni"
		even
Gra_SYZ:			incbin	"Enhancements/artkos/8x8 - SYZ.kosp"	; SYZ primary patterns
		even
	if TweakUncompressedChunkMapping
...
Blk16_SBZ:		incbin	"Enhancements/map16/SBZ.eni"
		even
Gra_SBZ:			incbin	"Enhancements/artkos/8x8 - SBZ.kosp"	; SBZ primary patterns
		even
Blk256_SBZ:
	if Revision=0
		if TweakUncompressedChunkMapping
